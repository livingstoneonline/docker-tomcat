...
--
-- Host: localhost    Database: fedora3
-- ------------------------------------------------------
...
INSERT INTO `doFields` VALUES ('fedora-system:FedoraObject-3.0','content model object for all objects','a','fedoraadmin',1214975383796,1460115226781,1214975384359,' content model object for all objects .',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' fedora-system:fedoraobject-3.0 .',NULL,NULL,NULL,NULL,NULL),('fedora-system:ServiceDeployment-3.0','content model object for service deployment objects','a','fedoraadmin',1214975383796,1460115226997,1214975384406,' content model object for service deployment objects .',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' fedora-system:servicedeployment-3.0 .',NULL,NULL,NULL,NULL,NULL),('fedora-system:ServiceDefinition-3.0','content model object for service definition objects','a','fedoraadmin',1214975383796,1460115226916,1214975384375,' content model object for service definition objects .',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' fedora-system:servicedefinition-3.0 .',NULL,NULL,NULL,NULL,NULL),('fedora-system:ContentModel-3.0','content model object for content model objects','a','fedoraadmin',1214975383796,1460115225898,1214975384015,' content model object for content model objects .',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,' fedora-system:contentmodel-3.0 .',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `doRegistry` VALUES ('fedora-system:ContentModel-3.0',1,'the userID field is no longer used','A','the label field is no longer used'),('fedora-system:FedoraObject-3.0',1,'the userID field is no longer used','A','the label field is no longer used'),('fedora-system:ServiceDefinition-3.0',1,'the userID field is no longer used','A','the label field is no longer used'),('fedora-system:ServiceDeployment-3.0',1,'the userID field is no longer used','A','the label field is no longer used');
...
INSERT INTO `fcrepoRebuildStatus` VALUES (1460116778011,1);
...
-- Dump completed on 2016-04-08 12:00:07
